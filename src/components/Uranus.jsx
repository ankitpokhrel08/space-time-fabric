...
export default function Uranus({ size }) {
  const starRef = useRef();
  const starTexture = useLoader(TextureLoader, "/assets/uranus_surface.jpg");
  ...
  return (
    <>
      <mesh ref={starRef}>
        ...
        {APP_CONFIG.displayLabel && <PlanetLabel title="Uranus" />}
      </mesh>
    </>
  );
}
